...
public class Parser {
  ...
  public static ArrayList<String> splitEqually(String[] items, int index,
      int numOfGroups) {
    ...
    for(int start = 0; start < items.length; start += size) {
      String[] subSetOfItems = Arrays.copyOfRange(items, start,
  ...
  public static String findContent(String[] items, int from, int to, int index,
      int numOfGroups) {
